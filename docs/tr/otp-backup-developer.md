...
Backups are just text files with one otpauth URI per line. Otpauth URI'lerine ilişkin belgelere [buradan](https://github.com/google/google-authenticator/wiki/Key-Uri-Format) ulaşılabilir. Örneğin, bir yedekleme böyle bir şeye benzeyebilir:
